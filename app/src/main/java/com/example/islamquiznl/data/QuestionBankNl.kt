...
object QuestionBankNl {
    ...
    val questions: List<Question> = listOf(
        ...
        Question(
            ...
            category = QuizCategory.HADITH,
            difficulty = Difficulty.MEDIUM,
            question = "Wat betekent 'ḥasan' bij een hadithclassificatie?",
            answers = listOf("Goed/acceptabel volgens hadithcriteria", "Verzonnen", "Zonder overleveringsketen", "Een Qur'anvers"),
            correctAnswerIndex = 0,
            explanation = "Ḥasan betekent dat een hadith goed/acceptabel is volgens hadithcriteria, maar meestal onder ṣaḥīḥ staat.",
            hint = "Het is een positieve classificatie.",
            extraHint = "Het betekent letterlijk iets als 'goed/mooi'.",
            sourceCategory = "Hadithwetenschap"
        ),
        Question(
            id = 137,
        ...
        Question(
            ...
            category = QuizCategory.AKHLAAQ,
            difficulty = Difficulty.EASY,
            question = "Welke eigenschap betekent dankbaarheid tegenover Allah?",
            answers = listOf("Shukr", "Kibr", "Hasad", "Riyā'"),
            correctAnswerIndex = 0,
            explanation = "Shukr betekent dankbaarheid tegenover Allah voor Zijn gunsten.",
            hint = "Het tegenovergestelde is ondankbaarheid.",
            extraHint = "Dankbaarheid kan met hart, tong en daden zijn.",
            sourceCategory = "Akhlaaq"
        ),
        Question(
            id = 144,
